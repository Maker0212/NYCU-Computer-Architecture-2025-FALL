                ...
                module imuldiv_MulDivReqMsgToStr
                  ...
                  begin
                    ...
                    begin
                      case ( func )
                        mul     :
                          $sformat( full_str, "mul  %d, %d", a, b );
                        div     :
                          $sformat( full_str, "div  %d, %d", a, b );
                        divu    :
                          $sformat( full_str, "divu %d, %d", a, b );
                        rem     :
                          $sformat( full_str, "rem  %d, %d", a, b );
                        remu    :
                          $sformat( full_str, "remu %d, %d", a, b );
                        default :
                          $sformat( full_str, "undefined func" );
                      endcase
                    end
